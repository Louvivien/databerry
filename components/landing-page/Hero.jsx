...
export function Hero() {
  return (
    <Container className="relative z-10 pt-20 pb-16 mb-12 text-center lg:pt-32">
      ...
      <Link target='_blank' href={'https://app.databerry-one.vercel.app/signin'}>
      ...
      <div className="flex justify-center mt-10 gap-x-6">
        {/* <Button target="_blank" href="https://app.databerry-one.vercel.app/signin">Start Building</Button> */}
        {/* <Button
